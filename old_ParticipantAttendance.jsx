...
export default function ParticipantAttendance() {
    ...
    const Badge = ({ val }) => {
        if (val === null) return <span style={{ color: K.dim, fontSize: '0.75rem' }}>ΓÇö</span>;
        return val
            ? <span style={{ color: '#4ade80', fontSize: '1rem' }}>Γ£à</span>
            : <span style={{ color: '#ef4444', fontSize: '1rem' }}>Γ¥î</span>;
    };

    return (
        <div style={{ padding: '40px 20px', maxWidth: '800px', margin: '0 auto', fontFamily: "'Rajdhani', sans-serif" }}>
            <div style={{ textAlign: 'center', marginBottom: '40px' }}>
                <div style={{ fontSize: '2rem', marginBottom: '8px' }}>≡ƒôï</div>
